...
@section('content')
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Editar
                ocorrência</h2>
            ...
            <form action="{{ route('ocorrencias.update') }}" method="PUT" class="space-y-8">
                @csrf
                <div>
                ...
                <div>
                    <label for="título"
                        class="block mb-2 text-sm font-bold text-gray-900 dark:text-gray-300">Título</label>
